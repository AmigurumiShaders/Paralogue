...
#include "Paralogue/Public/NodeEncounterSegmentData.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeNodeEncounterSegmentData() {}

// Begin Cross Module References
COREUOBJECT_API UClass* Z_Construct_UClass_UObject();
PARALOGUE_API UClass* Z_Construct_UClass_UPlogRtEncounterBranchNodeUserData();
PARALOGUE_API UClass* Z_Construct_UClass_UPlogRtEncounterBranchNodeUserData_NoRegister();
PARALOGUE_API UClass* Z_Construct_UClass_UPlogRtEncounterSegmentNodeUserData();
PARALOGUE_API UClass* Z_Construct_UClass_UPlogRtEncounterSegmentNodeUserData_NoRegister();
PARALOGUE_API UClass* Z_Construct_UClass_UPlogRtNodeUserData();
...
struct Z_Construct_UClass_UPlogRtNodeUserData_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		...
		{ "IncludePath", "NodeEncounterSegmentData.h" },
		{ "ModuleRelativePath", "Public/NodeEncounterSegmentData.h" },
		{ "ToolTip", "<summary>\nBase class for storing the data that the user enters into each node\n</summary>" },
	};
...
template<> PARALOGUE_API UClass* StaticClass<UPlogRtNodeUserData>()
{
	return UPlogRtNodeUserData::StaticClass();
}
...
template<> PARALOGUE_API UClass* StaticClass<UPlogRtEncounterSegmentNodeUserData>()
{
	return UPlogRtEncounterSegmentNodeUserData::StaticClass();
}
...
template<> PARALOGUE_API UClass* StaticClass<UPlogRtEncounterBranchNodeUserData>()
{
	return UPlogRtEncounterBranchNodeUserData::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_My_Stuff__Projects_UE_sandbox_Plugins5_4_Plugins_Paralogue__Package_Paralogue_HostProject_Plugins_Paralogue_Source_Paralogue_Public_NodeEncounterSegmentData_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPlogRtNodeUserData, UPlogRtNodeUserData::StaticClass, TEXT("UPlogRtNodeUserData"), &Z_Registration_Info_UClass_UPlogRtNodeUserData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlogRtNodeUserData), 3132360767U) },
		{ Z_Construct_UClass_UPlogRtEncounterSegmentNodeUserData, UPlogRtEncounterSegmentNodeUserData::StaticClass, TEXT("UPlogRtEncounterSegmentNodeUserData"), &Z_Registration_Info_UClass_UPlogRtEncounterSegmentNodeUserData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlogRtEncounterSegmentNodeUserData), 2283329755U) },
		{ Z_Construct_UClass_UPlogRtEncounterBranchNodeUserData, UPlogRtEncounterBranchNodeUserData::StaticClass, TEXT("UPlogRtEncounterBranchNodeUserData"), &Z_Registration_Info_UClass_UPlogRtEncounterBranchNodeUserData, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPlogRtEncounterBranchNodeUserData), 1108787242U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_My_Stuff__Projects_UE_sandbox_Plugins5_4_Plugins_Paralogue__Package_Paralogue_HostProject_Plugins_Paralogue_Source_Paralogue_Public_NodeEncounterSegmentData_h_496478875(TEXT("/Script/Paralogue"),
	Z_CompiledInDeferFile_FID_My_Stuff__Projects_UE_sandbox_Plugins5_4_Plugins_Paralogue__Package_Paralogue_HostProject_Plugins_Paralogue_Source_Paralogue_Public_NodeEncounterSegmentData_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_My_Stuff__Projects_UE_sandbox_Plugins5_4_Plugins_Paralogue__Package_Paralogue_HostProject_Plugins_Paralogue_Source_Paralogue_Public_NodeEncounterSegmentData_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
