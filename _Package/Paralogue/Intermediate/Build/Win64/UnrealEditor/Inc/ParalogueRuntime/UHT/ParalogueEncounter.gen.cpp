...
#include "ParalogueRuntime/Public/ParalogueEncounter.h"
...
PARALOGUERUNTIME_API UClass* Z_Construct_UClass_UEncounterSegment();
PARALOGUERUNTIME_API UClass* Z_Construct_UClass_UEncounterSegment_NoRegister();
PARALOGUERUNTIME_API UClass* Z_Construct_UClass_UParalogueEncounter();
PARALOGUERUNTIME_API UClass* Z_Construct_UClass_UParalogueEncounter_NoRegister();
...
template<> PARALOGUERUNTIME_API UClass* StaticClass<UEncounterSegment>()
{
	return UEncounterSegment::StaticClass();
}
...
struct Z_Construct_UClass_UParalogueEncounter_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam Class_MetaDataParams[] = {
		{ "BlueprintType", "true" },
		{ "Comment", "//class UParalogueEncounterEdGraphData; //forward delcaration, because we need to be able to use UEncounterSegment in UPlogRtEncounterSegmentNodeData, but without creating a circular dependency\n" },
		{ "IncludePath", "ParalogueEncounter.h" },
		{ "IsBlueprintBase", "true" },
		{ "ModuleRelativePath", "Public/ParalogueEncounter.h" },
		{ "ToolTip", "class UParalogueEncounterEdGraphData; forward delcaration, because we need to be able to use UEncounterSegment in UPlogRtEncounterSegmentNodeData, but without creating a circular dependency" },
	};
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_Segments_MetaData[] = {
		{ "Comment", "//[todo: probably should use props rather than public variables for that array]\n//VisibleAnywhere, Category = \"Content\")\n" },
		{ "ModuleRelativePath", "Public/ParalogueEncounter.h" },
		{ "ToolTip", "[todo: probably should use props rather than public variables for that array]\nVisibleAnywhere, Category = \"Content\")" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FlagsSet_MetaData[] = {
		{ "Category", "Flags" },
		{ "Comment", "/*List of all route flags that may be set during this encounter*/" },
		{ "ModuleRelativePath", "Public/ParalogueEncounter.h" },
		{ "ToolTip", "List of all route flags that may be set during this encounter" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_FlagsChecked_MetaData[] = {
		{ "Category", "Flags" },
		{ "Comment", "/*List of all route flags that may be checked during this encounter*/" },
		{ "ModuleRelativePath", "Public/ParalogueEncounter.h" },
		{ "ToolTip", "List of all route flags that may be checked during this encounter" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_startingSegment_MetaData[] = {
		{ "Comment", "//VisibleAnywhere, Category = \"AAAAAAAAA\")\n" },
		{ "ModuleRelativePath", "Public/ParalogueEncounter.h" },
		{ "ToolTip", "VisibleAnywhere, Category = \"AAAAAAAAA\")" },
	};
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_PlayerOptionsForSegment_MetaData[] = {
		{ "Category", "AAAAAAAAA" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_AwaitingPlayerSelection_MetaData[] = {
		{ "Category", "AAAAAAAAA" },
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_BlankSingleOption_MetaData[] = {
		{ "Category", "AAAAAAAAA" },
		{ "Comment", "//Allowing for skipping single blank player responses\n" },
		{ "ModuleRelativePath", "Public/ParalogueEncounter.h" },
		{ "ToolTip", "Allowing for skipping single blank player responses" },
	};
	...
	static const UECodeGen_Private::FNamePropertyParams NewProp_FlagsSet_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_FlagsSet;
	static const UECodeGen_Private::FNamePropertyParams NewProp_FlagsChecked_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_FlagsChecked;
	static const UECodeGen_Private::FObjectPropertyParams NewProp_startingSegment;
	static const UECodeGen_Private::FTextPropertyParams NewProp_PlayerOptionsForSegment_Inner;
	static const UECodeGen_Private::FArrayPropertyParams NewProp_PlayerOptionsForSegment;
	static void NewProp_AwaitingPlayerSelection_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_AwaitingPlayerSelection;
	static void NewProp_BlankSingleOption_SetBit(void* Obj);
	static const UECodeGen_Private::FBoolPropertyParams NewProp_BlankSingleOption;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_Segments_Inner = { "Segments", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, Z_Construct_UClass_UEncounterSegment_NoRegister, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_Segments = { "Segments", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParalogueEncounter, Segments), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_Segments_MetaData), NewProp_Segments_MetaData) };
const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_FlagsSet_Inner = { "FlagsSet", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_FlagsSet = { "FlagsSet", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParalogueEncounter, FlagsSet), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FlagsSet_MetaData), NewProp_FlagsSet_MetaData) };
const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_FlagsChecked_Inner = { "FlagsChecked", nullptr, (EPropertyFlags)0x0000000000020000, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_FlagsChecked = { "FlagsChecked", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParalogueEncounter, FlagsChecked), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_FlagsChecked_MetaData), NewProp_FlagsChecked_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_startingSegment = { "startingSegment", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParalogueEncounter, startingSegment), Z_Construct_UClass_UEncounterSegment_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_startingSegment_MetaData), NewProp_startingSegment_MetaData) };
const UECodeGen_Private::FTextPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_PlayerOptionsForSegment_Inner = { "PlayerOptionsForSegment", nullptr, (EPropertyFlags)0x0000000000000000, UECodeGen_Private::EPropertyGenFlags::Text, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, 0, METADATA_PARAMS(0, nullptr) };
const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_PlayerOptionsForSegment = { "PlayerOptionsForSegment", nullptr, (EPropertyFlags)0x0010000000002014, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UParalogueEncounter, PlayerOptionsForSegment), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_PlayerOptionsForSegment_MetaData), NewProp_PlayerOptionsForSegment_MetaData) };
void Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_AwaitingPlayerSelection_SetBit(void* Obj)
{
	((UParalogueEncounter*)Obj)->AwaitingPlayerSelection = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_AwaitingPlayerSelection = { "AwaitingPlayerSelection", nullptr, (EPropertyFlags)0x0010000000002014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UParalogueEncounter), &Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_AwaitingPlayerSelection_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_AwaitingPlayerSelection_MetaData), NewProp_AwaitingPlayerSelection_MetaData) };
void Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_BlankSingleOption_SetBit(void* Obj)
{
	((UParalogueEncounter*)Obj)->BlankSingleOption = 1;
}
const UECodeGen_Private::FBoolPropertyParams Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_BlankSingleOption = { "BlankSingleOption", nullptr, (EPropertyFlags)0x0010000000002014, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(UParalogueEncounter), &Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_BlankSingleOption_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_BlankSingleOption_MetaData), NewProp_BlankSingleOption_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UParalogueEncounter_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_FlagsSet_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_FlagsSet,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_FlagsChecked_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_FlagsChecked,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_startingSegment,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_PlayerOptionsForSegment_Inner,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_PlayerOptionsForSegment,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_AwaitingPlayerSelection,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UParalogueEncounter_Statics::NewProp_BlankSingleOption,
...
template<> PARALOGUERUNTIME_API UClass* StaticClass<UParalogueEncounter>()
{
	return UParalogueEncounter::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_My_Stuff__Projects_UE_sandbox_Plugins5_4_Plugins_Paralogue__Package_Paralogue_HostProject_Plugins_Paralogue_Source_ParalogueRuntime_Public_ParalogueEncounter_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UEncounterSegment, UEncounterSegment::StaticClass, TEXT("UEncounterSegment"), &Z_Registration_Info_UClass_UEncounterSegment, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UEncounterSegment), 4044243444U) },
		{ Z_Construct_UClass_UParalogueEncounter, UParalogueEncounter::StaticClass, TEXT("UParalogueEncounter"), &Z_Registration_Info_UClass_UParalogueEncounter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UParalogueEncounter), 308528596U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_My_Stuff__Projects_UE_sandbox_Plugins5_4_Plugins_Paralogue__Package_Paralogue_HostProject_Plugins_Paralogue_Source_ParalogueRuntime_Public_ParalogueEncounter_h_1182590417(TEXT("/Script/ParalogueRuntime"),
	Z_CompiledInDeferFile_FID_My_Stuff__Projects_UE_sandbox_Plugins5_4_Plugins_Paralogue__Package_Paralogue_HostProject_Plugins_Paralogue_Source_ParalogueRuntime_Public_ParalogueEncounter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_My_Stuff__Projects_UE_sandbox_Plugins5_4_Plugins_Paralogue__Package_Paralogue_HostProject_Plugins_Paralogue_Source_ParalogueRuntime_Public_ParalogueEncounter_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
